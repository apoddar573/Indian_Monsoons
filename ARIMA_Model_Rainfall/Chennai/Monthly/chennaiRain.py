...
plt.savefig("MonthlyRainfallChennai.png")
plt.close()
...
plt.savefig("MonthlyRainfallChennai_ArimaModel.png")
print results
...
plt.savefig("MonthlyRainfallChennai_ArimaModel_3years.png")
plt.close()
