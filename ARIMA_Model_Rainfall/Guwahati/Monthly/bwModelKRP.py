...
bOrders = [(8, 0, 0), (8, 0, 1), (7, 0, 1), (7, 0, 0), (6, 0, 1)]
wOrders = [(1, 0, 1), (1, 0, 0), (0, 0, 2), (0, 0, 1), (0, 0, 0)]
...
for i in range(5):
	...
	fp.write("\n")
	plt.savefig("MonthlyRainfallKRP" + str(i) + "_" + str(bOrders[i]) + ".png")
...
for i in range(5):
	...
	fp.write("\n")
	plt.savefig("MonthlyRainfallKRP" + str(i+5) + "_" + str(wOrders[i]) + ".png")
	f.write(str(bOrders[i])+"\n")
	f.write("Monthly Variation: " + str(variation(results)) + "\n")
	f.write("Monsoon Variation: " + str(monsoonVariation(results)) + "\n")
	f.write("Annual Variation: " + str(annualVariation(results)) + "\n")
