...
bOrders = [(8, 0, 1), (8, 0, 0), (7, 0, 1), (2, 0, 3), (3, 0, 3)]
wOrders = [(1, 0, 1), (1, 0, 0), (1, 0, 2), (0, 0, 1), (0, 0, 0)]
...
for i in range(5):
	...
	plt.savefig("MonthlyRainfallBNG" + str(i) + "_" + str(bOrders[i]) + ".png")
...
for i in range(5):
	...
	plt.plot(results - ts, color = "BLACK", Label = "Variation")
	plt.title("RS: %.4f" %(sum((ts - results)**2)))
	plt.savefig("MonthlyRainfallBNG" + str(i+5) + "_" + str(wOrders[i]) + ".png")
	f.write(str(bOrders[i])+"\n")
	f.write("Monthly Variation: " + str(variation(results)) + "\n")
	f.write("Monsoon Variation: " + str(monsoonVariation(results)) + "\n")
	f.write("Annual Variation: " + str(annualVariation(results)) + "\n")
