...
data = pd.read_csv("monsoonRainBNG.csv")
...
plt.savefig("MonsoonRainfallBangalore.png")
plt.close()

model = ARIMA(ts, order = (1, 0, 0))
results_AR = model.fit(disp = -1)
plt.plot(ts, Label = "Monsoon Rainfall Data")
...
plt.savefig("AnnualRainfallBNG_ArimaModel.png")
p_values = range(9)
q_values = range(9)
d_values = [0]
